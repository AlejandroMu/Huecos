...
import com.example.huecoscolombia.R;
...
public class NotificationUtils {
    ...
    public static void createNotification(int id, String title, String msg) {
        ...
        manager = (NotificationManager) HuecosColombiaApp.getContext().getSystemService(Context.NOTIFICATION_SERVICE);
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.O){
            NotificationChannel canal = new NotificationChannel(CHANNEL_ID, CHANNEL_NAME, CHANNEL_IMPORTANCE);
            manager.createNotificationChannel(canal);
        }
        NotificationCompat.Builder builder = new NotificationCompat
                .Builder(HuecosColombiaApp.getContext(), CHANNEL_ID)
